...
ALLOWED_HOSTS = ['localhost','https://oumafobian1-8000.theianext-1-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai/']
CSRF_TRUSTED_ORIGINS = ['https://oumafobian1-8000.theianext-1-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai']
